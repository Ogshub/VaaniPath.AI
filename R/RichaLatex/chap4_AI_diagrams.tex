...
The Level 1 DFD shows six processes: Add Task, Display Tasks, Toggle Status, Delete Task, Check Alarms, and Sort Tasks.
...
The class diagram shows four main classes: Task, TaskManager, AlarmService, and LocalStorageService.
